...
class Halbayarparkir extends Component
{
    ...
    {
        $this->parkirDitemukan = Riwayatparkir::where('nomor_plat', $this->nomorPlat)->whereNull('wkatu_keluar')->first();
        if ($this->parkirDitemukan) {
            $this->catatan = 'Data ditemukan';
            ...
            $this->catatan = 'Data tidak ditemukan';
        }
    }
